...
/// @brief 调整布局事件.
/// @code int CALLBACK OnAdjustLayout(BOOL *pbHandled); @endcode
#define  XE_ADJUSTLAYOUT         17

/// @brief 调整布局完成事件.
/// @code int CALLBACK OnAdjustLayoutEnd(BOOL *pbHandled); @endcode
...
XC_API XC_OBJECT_TYPE    WINAPI XUI_GetType(HXCGUI hXCGUI);
XC_API XC_OBJECT_TYPE_EX WINAPI XUI_GetTypeEx(HXCGUI hXCGUI);
...
XC_API BOOL WINAPI XEle_IsEnableLayout(HELE hEle);
...
XC_API void WINAPI XEle_EnableLayout(HELE hEle, BOOL bEnable);
XC_API int  WINAPI XEle_SetRect(HELE hEle, RECT *pRect, BOOL bRedraw = FALSE);
XC_API int  WINAPI XEle_SetRectEx(HELE hEle, int x, int y, int cx, int cy, BOOL bRedraw = FALSE);
XC_API int  WINAPI XEle_SetRectLogic(HELE hEle, RECT *pRect, BOOL bRedraw = FALSE); //逻辑模式坐标
...
XC_API BOOL WINAPI XLayout_IsShow(HXCGUI hLayout);
...
XC_API HBKM WINAPI XLayout_GetBkManager(HXCGUI hLayout);
...
XC_API void WINAPI XLayout_SetName(HXCGUI hLayout, const wchar_t* pName);
XC_API const wchar_t* WINAPI XLayout_GetName(HXCGUI hLayout);
...
XC_API void WINAPI XLayout_Show(HXCGUI hLayout, BOOL bShow);
XC_API void WINAPI XLayout_ShowLayoutFrame(HXCGUI hLayout, BOOL bShow);
...
XC_API void WINAPI XLayout_DrawFrame(HXCGUI hLayout, HDRAW hDraw);
